...
Each row contains the relative position ($r$) of a read aligned to the reference and the CIGAR string.
We initialize aligned sequence and quality strings with '&ndash;' and '!' ($Q=0$) repeated $r$ times, respectively.
...
Deleted bases are arbitrarily assigned a quality score of zero.
After all reads are processed, we initialize an empty $5\times\ell$ matrix $\nps'$, where $\ell$ is initialized to the length of the longest aligned sequence.
