...
Other than filtering data and possibly being used for alignment, the uncertainty present in the sequences are seldom propagated to downstream analyses.
...
The use of $\tilda a_{(j)}$ ensure that the sequence uncertainties sum to 1, giving a proper weighting to the $\theta$ parameters.
