...
The clock rate for SARS-CoV-2 is estimated to be [fixed|uncorrelated] (citation needed).
Using similar resampling methods as above (although without indels), we estimate the clock rate for each of X resamples, as well as the reported conseqs.
...
The full list of accession numbers sampled this way are given in the appendix. 

The clock rate was estimated using TreeTime (reference). 
...
The results speak for themselves (hopefully - I haven't seen them yet).
