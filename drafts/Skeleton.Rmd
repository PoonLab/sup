...
As we will later demonstrate, a matrix populated from short read data 
...
This compact representation drastically reduces the space of all possible sequences, \ie $m\ll 5^\ell$.
...
Large genomes, such as SARS-CoV-2, will result in vanishingly small probabilities for all sequences, and thus calculations on the log scale are often preferred.
