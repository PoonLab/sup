...
\subsubsection{Sequence as a simple string (FASTA format)}

The observation error estimated by the sampling platform may not always be available and only a string of character describes the sequence (FASTA format). 

\warning{TODO: describe the beta-uniform model and also the multinomial variant.}
