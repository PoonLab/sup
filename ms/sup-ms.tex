...
\begin{flushleft}
\textbf{\large Variance in Variants: Propagating Genome Sequence Uncertainty into Phylogenetic Lineage Assignment}\\[12pt]


Devan Becker\,$^{1,2,\footnote{To whom correspondence should be addressed. Email: dbecker7@uwo.ca}}$,
David Champredon\,$^{2}$
Connor Chato\,$^{1}$
Gopi Gugan\,$^{1}$
and Art Poon\,$^{1}$\\[12pt]
...
\begin{figure}[btp]
\centering
\includegraphics[width=0.8\linewidth]{figs/RTT_Slope.pdf}
