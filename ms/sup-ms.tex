...
The authors have not found documentation for this format, but are hopeful that our methods inspire greater use of this format.
...
For both the FASTQ and FATSA format, the uniform distribution was chosen for illustrative purposes.
