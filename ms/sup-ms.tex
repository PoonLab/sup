...
\author{David Champredon*$^1$, Devan Becker*$^1$, Connor Chato$^1$, Gopi Gugan$^1$, Art Poon$^1$}
\date{\small*contributed equally\\$^1$Department of Pathology and Laboratory Medicine, Schulich School of Medicine and Dentistry, Western University}
...
Figure \ref{fig:covidcalls} shows that the consensus sequence is almost always assigned the same lineage as the majority of the resamples; the full results are in the appendix.
...
Our analysis of Pangolin lineage classification demonstrates that the uncertainty in the base calls has a non-trivial affect on the potential lineage calls.
