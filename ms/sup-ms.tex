...
The short read files produced by next generation sequencing platforms include valuable information about the quality of base calls which can easily be propagated into analyses.
...
TODO: Split into Discussion and Conclusions (may require re-organizing the section).
...
Our method does not preclude tertiary analyses to test for systematic errors or deviations from a Mendelian inheritance pattern assumption. TODO: This came from a reference, find that reference and expand upon it.
We cannot account for systematic errors, such as those present due to human errors \citep[\eg as noted in][]{IssuesSARSCoV2Sequencing2020}. TODO: Fix this reference. 
...
TODO: Split the ERR and SRR into separate tables?
...
TODO: Remove duplicates (in sup-ms-figures.R)
% latex table generated in R 4.0.4 by xtable 1.8-4 package
