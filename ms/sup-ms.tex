...
TODO: add the accessions (with other info) to the appendix
...
TODO: \dc{I don't understand the point of this paragraph. Is it incomplete?}



\subsection{Clock rate estimation for SARS-CoV-2}

The clock rate (slope of a root-to-tip regression) for SARS-CoV-2 is commonly estimated as a fixed rate near 0.001 mutations per site per year (specific estimates given below TODO: \dc{even if that's detailed below, we may want to give the references here?}).
...
TODO: \dc{how many sequences did we end up using?}
...
TODO: \dc{How many sequences were removed after doing this? }
...
TODO: \dc{I'm not sure I understand well this paragraph... I guess we don't want to spend too long explaining here, but is there a way to clarify a bit more?}
